...
RUN dnf -qq -y update && dnf -qq -y install git aria2 mkvtoolnix bash xz wget curl pv jq python3-pip mediainfo psmisc procps-ng qbittorrent-nox && python3 -m pip install --upgrade pip setuptools
